...
public interface LegacyBeneficiaryRepository extends JpaRepository<LegacyBeneficiary, LegacyBeneficiaryId> {
    ...
    List<LegacyBeneficiary> findByAapresentaAndVftipoimpuAndCdpresentaAndCdsecubien(
    ...
    BigDecimal sumLegacyPercentage(@Param("aapresenta") String aapresenta,
                                   @Param("vftipoimpu") String vftipoimpu,
                                   @Param("cdpresenta") String cdpresenta,
                                   @Param("cdsecubien") String cdsecubien,
                                   @Param("cdnifcausa") String cdnifcausa,
                                   @Param("cdsubcausa") String cdsubcausa);
}
